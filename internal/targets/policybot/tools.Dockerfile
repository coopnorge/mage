...
RUN CGO_ENABLED=0 go build -o policy-bot-config-check main.go mockserver.go policybotserver.go

FROM alpine:3.22.2@sha256:4b7ce07002c69e8f3d704a9c5d6fd3053be500b7f1c69fc0d80990c2ad8dd412 AS policy-bot-config-check-arm64
...
FROM policy-bot-config-check-arm64 AS policy-bot-config-check-amd64
