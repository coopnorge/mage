...
func TestTargets(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			testProject: "testdata/success",
			targets:     []string{"terraform:lint"},
			wantErr:     false,
		},
		{
			name:        "Terraform LintFix target should succeed",
			testProject: "testdata/success",
			targets:     []string{"terraform:lintfix"},
			wantErr:     false,
		},
		{
		...
		},
		{
			...
			testProject: "testdata/fail-fmt",
			targets:     []string{"terraform:lintfix", "terraform:lint"},
			wantErr:     false,
		},
		{
			name:        "Terraform Security target should succeed",
			testProject: "testdata/success",
			targets:     []string{"terraform:security"},
			wantErr:     false,
		},
		{
		...
		},
		{
			...
			testProject: "testdata/success",
			targets:     []string{"terraform:initupgrade"},
			wantErr:     false,
		},
		{
			name:        "Terraform LockProviders target should succeed",
			testProject: "testdata/success",
			targets:     []string{"terraform:lockproviders"},
			wantErr:     false,
		},
	}
